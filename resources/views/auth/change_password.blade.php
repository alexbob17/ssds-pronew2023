...
<body class="hold-transition">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <div class="col-md-9">
                <div class="form-group-container col-md-9">
                    <div class="form-group has-feedback">
                        {!! Form::password('current_password', ['class' => 'form-control', 'placeholder' => 'Contraseña
                        actual']) !!}
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        {!! Form::password('new_password', ['class' => 'form-control', 'placeholder' => 'Contraseña
                        nueva'])
                        !!}
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
