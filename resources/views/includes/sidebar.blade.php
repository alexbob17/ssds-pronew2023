    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                <a href="#">
                    <i class="fa fa-bug"></i> <span>Inconsistencias</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                        ...
                        <ul class="treeview-menu menu-open" style="display: block">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    @endif
                                    @role(['admin', 'operador'])
                                    <li>{!! Html::decode(link_to('/penalizaciones/registro','<i class="fa fa-book"></i>
                                        Registro')) !!}</li>
                                    @endrole
                                    @role(['admin'])
                                                    ...
                                                    <li class="treeview">
                                                        ...
                                                        <ul class="treeview-menu">
                                                            ...
                                                            <li>{!! Html::decode(link_to('/usuarios','<i
                                                                    class="fa fa-users"></i> Usuarios')) !!}</li>
                                                            @endrole
                                                        </ul>
                                                    </li>
                                                    @endrole
