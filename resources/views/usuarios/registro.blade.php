		...
		<div class="box box-warning">
        	...
        	{!! Form::open(['url' => '/usuarios/registro', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
				<div class="box-body">
					...
					<div class="form-group-container">
						{!! Form::inputWithIcon('fa-file', 6, 'organizational_area', $errors, trans('usuarios/registro.organizational_area')) !!}
						{!! Form::selection(6, 'role', $errors, $roles, null, trans('usuarios/registro.role'), trans('usuarios/registro.ph_role')) !!}
					</div>
					<div class="form-group-container">
						{!! Form::inputPassword('fa-lock', 6, 'password', $errors, trans('usuarios/registro.password')) !!}
						{!! Form::inputPassword('fa-lock', 6, 'password_confirmation', $errors, trans('usuarios/registro.password_confirmation')) !!}
					</div>
				</div>
				<!-- /.box-body -->
