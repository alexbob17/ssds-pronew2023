		...
		<div class="box box-warning">
        	...
        	<div class="box-body">
        		<div class="form-group-container">
					{!! Form::inputWithIcon('fa-calendar', 3, 'fecha_inicial', $errors, null, null, trans('qflows/reporte.fecha_inicial')) !!}
					{!! Form::inputWithIcon('fa-calendar', 3, 'fecha_final', $errors, null, null, trans('qflows/reporte.fecha_final')) !!}
					{!! Form::selection(3, 'username', $errors, $usernames, null, null, trans('qflows/reporte.username')) !!}
