<div class="box box-warning">
        ...
        <div class="form-group-container">
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="motivollamada" name="motivollamada" readonly="readonly"
                    placeholder="INSTALACION" style="background: #f9f936;" />
            </div>
            <div class="form-group col-md-3">
    ...
    <div class="box box-warning">
        <form action="POST" id="form2" method="post" class="box-body">
            <div class="form-group-container" style="margin-top: 2.5rem;">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="orden_tv_hfc" name="orden_tv_hfc" required />
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="orden_linea_hfc" name="orden_linea_hfc" required />
                </div>
            </div>
            <div class="form-group-container" style="margin-top: 2.5rem;">
                <div class="form-group col-md-3">
            ...
            <div class="form-group-container">
                <h4 class="box-title" style="color: #3e69d6; text-align: center; font-weight: bold;">Elementos
                    de red</h4>
            ...
            <div class="form-group-container">
                ...
                <div class="form-group-container">
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" class="form-control" id="observaciones-form3" name="observaciones-form3"
                            required />
                    </div>
                    <div class="form-group col-md-9">
                        <label for="telefono">Materiales</label>
                        <input type="text" class="form-control" id="materiales-form3" name="materiales-form3" required
        ...
        <!-- FORMULARIO #5-->
        <form action="POST" id="form5" method="post" class="box-body">
            <div class="form-group-container">
                <div class="form-group col-md-3" style="margin-top: 3rem; text-align: center;">
                    <label for="" style="color: #3e69d6; font-size: 18px;">Solicitudes</label>
                </div>
    ...
    <!-- FORMULARIO #6-->
    <form action="POST" id="form6" method="post" class="box-body">
        <div class="form-group-container" style="margin-top: 2.5rem;">
            <div class="form-group col-md-3" style="margin-top: 3rem; text-align: center;">
                <label for="" style="color: #3e69d6; font-size: 18px;">Solicitudes</label>
            </div>
