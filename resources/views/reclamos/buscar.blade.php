         ...
         <div class="box box-primary">
             ...
             <div class="box-body">
                 <div class="form-group-container">
                     ...
                     {!! Form::button('Buscar', ['id' => 'buscar', 'class' => 'btn btn-primary', 'style' =>
                     'margin-left: 15px']) !!}
                 </div>
             </div>
             <!-- /.box-body -->
             ...
             <div class="box-body table-responsive no-padding">
                 <table class="table table-bordered table-hover table-result">
                     <thead>
                         <tr>
                             <th></th>
                             <th>{!! trans('reclamos/buscar.ticket') !!}</th>
                             <th>{!! trans('reclamos/buscar.codigo_tecnico') !!}</th>
                             <th>{!! trans('reclamos/buscar.nombre_tecnico') !!}</th>
                             <th>{!! trans('reclamos/buscar.id_producto') !!}</th>
                             <th>{!! trans('reclamos/buscar.estado') !!}</th>
                             <th>{!! trans('reclamos/buscar.login_usuario') !!}</th>
                             <th>{!! trans('reclamos/buscar.fecha_creacion') !!}</th>
                         </tr>
                     </thead>
                     <tbody>
                         <tr>
