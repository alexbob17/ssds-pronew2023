$(function () {
	var locales = {
		...
		excel_filename :  'Reporte de Reclamos Area Tecnica Atendidos'
	};
    ...
    .on('changeDate', function(selected) {
     ...
     .DataTable({
		...
		ajax: {
			method: 'GET',
			url: APP_URL + '/reclamos/reclamos-atendidos',
			data: function(d) {
			...
			dataSrc: function(json) {
				for(var i = 0, ien = json.length ; i < ien ; i++) {
					...
					json[i].resolucion_tecnica = '<span>' + json[i].resolucion_tecnica + '</span>';
				}
				return json;
			},
